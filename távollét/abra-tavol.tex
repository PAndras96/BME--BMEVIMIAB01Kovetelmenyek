...
%	\draw[brown] (-2*\pontMeret,-4*\kisTengelyEltolas-2*\nagyTengelyEltolas) node[anchor=east]{\makecell[r]{{\color{red}Minimumkövetelmény}\\Jelenlét gyakorlaton}} --++(14*\pontMeret,0)
%	(-2*\pontMeret,-4*\kisTengelyEltolas-2*\nagyTengelyEltolas)--++(0,\nagyOsztas) node[anchor=west]{$0$}
%	(-\pontMeret,-4*\kisTengelyEltolas-2*\nagyTengelyEltolas)--++(0,\kisOsztas)
%	(0,-4*\kisTengelyEltolas-2*\nagyTengelyEltolas)--++(0,\kisOsztas)
%	(\pontMeret,-4*\kisTengelyEltolas-2*\nagyTengelyEltolas)--++(0,\kisOsztas)
%	(2*\pontMeret,-4*\kisTengelyEltolas-2*\nagyTengelyEltolas)--++(0,\kisOsztas)
%	(3*\pontMeret,-4*\kisTengelyEltolas-2*\nagyTengelyEltolas)--++(0,\nagyOsztas) node[anchor=west]{$5$}
%	(4*\pontMeret,-4*\kisTengelyEltolas-2*\nagyTengelyEltolas)--++(0,\kisOsztas)
%	(5*\pontMeret,-4*\kisTengelyEltolas-2*\nagyTengelyEltolas)--++(0,\kisOsztas)
%	(6*\pontMeret,-4*\kisTengelyEltolas-2*\nagyTengelyEltolas)--++(0,\kisOsztas)
%	(7*\pontMeret,-4*\kisTengelyEltolas-2*\nagyTengelyEltolas)--++(0,\kisOsztas)
%	(8*\pontMeret,-4*\kisTengelyEltolas-2*\nagyTengelyEltolas)--++(0,\nagyOsztas)
%	(9*\pontMeret,-4*\kisTengelyEltolas-2*\nagyTengelyEltolas)--++(0,\kisOsztas)
%	(10*\pontMeret,-4*\kisTengelyEltolas-2*\nagyTengelyEltolas)--++(0,\kisOsztas)
%	(11*\pontMeret,-4*\kisTengelyEltolas-2*\nagyTengelyEltolas)--++(0,\kisOsztas)
%	(12*\pontMeret,-4*\kisTengelyEltolas-2*\nagyTengelyEltolas)--++(0,\nagyOsztas) node[anchor=east]{$14$};
%	% Gyakorlati jelenlét követelmény
%	\pontMarker{8*\pontMeret}{-4*\kisTengelyEltolas-2*\nagyTengelyEltolas+\nagyOsztas}{\nagyOsztas-\kisOsztas+\jegyMagassag}{red}{$10$}
%	\draw[red] (-2*\pontMeret,-4*\kisTengelyEltolas-2*\nagyTengelyEltolas+0.5*\kisOsztas)--++(10*\pontMeret,0);
\end{tikzpicture}